...
const navItems: NavItem[] = [
  ...
  { label: "Norm Kadro", icon: <Users size={18} />, page: "staffing-plan" },
  {
    label: "Ta015feron 0130015f Takibi",
    icon: <HardHat size={18} />,
    page: "subcontractor",
  },
  {
    label: "Sigorta Poli00e7eleri",
    icon: <BriefcaseBusiness size={18} />,
    page: "insurance",
  },
  {
    label: "Enerji Verimlili011fi",
    icon: <Leaf size={18} />,
    page: "energy-targets",
  },
  {
  ...
  { label: "Saha Denetimi", icon: <Search size={18} />, page: "field-audits" },
  {
  ...
  { label: "Atık Bertaraf", icon: <Leaf size={18} />, page: "waste-disposal" },
  {
  ...
  {
    label: "Proje Değişiklik",
    icon: <GitMerge size={18} />,
    page: "project-changes",
  },
  {
    label: "Doküman Revizyon",
